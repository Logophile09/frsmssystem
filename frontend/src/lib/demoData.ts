...
// ---------------------------------------------------------------------
const rawIncidents = [
  { id: 1, incident_number: 'INC-2026-0001', incident_type: 'Structure Fire', description: 'Reported fire on the 2nd floor of a residential building.', location: 'Tandang Sora Ave., Brgy. Culiat, Quezon City', severity: 'high', status: 'resolved', created_at: daysAgo(14), resolved_at: offset(daysAgo(14), 3),
  ...
  { id: 2, incident_number: 'INC-2026-0002', incident_type: 'Vehicular Accident', description: 'Two-vehicle collision, one injured.', location: 'Visayas Ave., Brgy. Culiat, Quezon City', severity: 'moderate', status: 'resolved', created_at: daysAgo(12), resolved_at: offset(daysAgo(12), 2),
  ...
  { id: 3, incident_number: 'INC-2026-0003', incident_type: 'Grass Fire', description: 'Small grass fire near a vacant lot, contained quickly.', location: 'Culiat Road, Brgy. Culiat, Quezon City', severity: 'low', status: 'resolved', created_at: daysAgo(11), resolved_at: offset(daysAgo(11), 1),
  ...
  { id: 4, incident_number: 'INC-2026-0004', incident_type: 'Medical Emergency', description: 'Elderly patient with chest pains.', location: 'Kalayaan St., Brgy. Culiat, Quezon City', severity: 'moderate', status: 'resolved', created_at: daysAgo(9), resolved_at: offset(daysAgo(9), 1.5),
    is_anonymous_caller: false, caller_count: 2, smoke_sensor_triggered: false, fire_personnel_confirmed_smoke: false, false_alarm_review_status: 'confirmed_real' },
  { id: 5, incident_number: 'INC-2026-0005', incident_type: 'Structure Fire', description: 'Possible false alarm - smoke detector triggered, no visible fire on arrival.', location: 'Brgy. Culiat, Quezon City', severity: 'low', status: 'resolved', created_at: daysAgo(8), resolved_at: offset(daysAgo(8), 0.75),
  ...
  { id: 6, incident_number: 'INC-2026-0006', incident_type: 'Medical Emergency', description: 'Patient with chest pains.', location: 'Mabuhay St., Brgy. Culiat, Quezon City', severity: 'moderate', status: 'reported', created_at: daysAgo(6), resolved_at: null,
  ...
  { id: 7, incident_number: 'INC-2026-0007', incident_type: 'Medical Emergency', description: 'Fall injury, ambulance requested.', location: 'Tandang Sora Ave. corner Visayas Ave., Brgy. Culiat, Quezon City', severity: 'moderate', status: 'reported', created_at: daysAgo(5), resolved_at: null,
  ...
  { id: 8, incident_number: 'INC-2026-0008', incident_type: 'Grass Fire', description: 'Small brush fire spreading toward fence line.', location: 'Brgy. Culiat, Quezon City', severity: 'low', status: 'reported', created_at: daysAgo(4), resolved_at: null,
  ...
  { id: 9, incident_number: 'INC-2026-0009', incident_type: 'Vehicular Accident', description: 'Rear-end collision, minor injuries reported.', location: 'Visayas Ave. corner Tandang Sora Ave., Brgy. Culiat, Quezon City', severity: 'low', status: 'reported', created_at: daysAgo(3), resolved_at: null,
    is_anonymous_caller: false, caller_count: 2, smoke_sensor_triggered: false, fire_personnel_confirmed_smoke: false, false_alarm_review_status: 'pending' },
  { id: 10, incident_number: 'INC-2026-0010', incident_type: 'Structure Fire', description: 'Fire reported at commercial building, crews on site.', location: 'Brgy. Culiat, Quezon City', severity: 'high', status: 'resolved', created_at: daysAgo(2), resolved_at: offset(daysAgo(2), 4),
  ...
  { id: 11, incident_number: 'INC-2026-0011', incident_type: 'Structure Fire', description: 'Possible false alarm - smoke detector triggered, no visible fire on arrival.', location: 'Brgy. Culiat, Quezon City', severity: 'low', status: 'dispatched', created_at: hoursAgo(5), resolved_at: null,
  ...
  { id: 12, incident_number: 'INC-2026-0012', incident_type: 'Structure Fire', description: 'Active fire, occupants trapped on 3rd floor, multiple casualties reported.', location: 'Culiat Road, Brgy. Culiat, Quezon City', severity: 'critical', status: 'on_scene', created_at: minutesAgo(40), resolved_at: null,
...
export function getDashboardSummary() {
  ...
  return {
    ...
    criticalUnresolved: active.filter((i) => i.severity === 'critical').length,
