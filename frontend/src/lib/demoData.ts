...
export const establishments = [
  { id: 1, business_name: 'Fairview Grand Mall', business_type: 'Mall / Commercial Complex', owner_name: 'Realty Holdings Corp.', barangay: 'Fairview', address: 'Maligaya St., Fairview, Quezon City', occupancy_type: 'Mercantile', storeys: 4, floor_area_sqm: 12500.0, contact_number: '0917-100-1001', date_registered: '2021-03-15', status: 'Active' },
  { id: 2, business_name: 'Commonwealth Fuel Station', business_type: 'Gasoline Station', owner_name: 'Petrolink Inc.', barangay: 'Commonwealth', address: 'Commonwealth Ave. corner Regalado', occupancy_type: 'Hazardous', storeys: 1, floor_area_sqm: 850.0, contact_number: '0917-100-1002', date_registered: '2020-06-02', status: 'Active' },
  { id: 3, business_name: 'Batasan Hills Medical Center', business_type: 'Hospital / Clinic', owner_name: 'Dra. Lourdes Aquino', barangay: 'Batasan Hills', address: 'Brgy. Batasan Hills, Quezon City', occupancy_type: 'Institutional', storeys: 5, floor_area_sqm: 6200.0, contact_number: '0917-100-1003', date_registered: '2019-01-20', status: 'Active' },
  { id: 4, business_name: 'Novaliches Central School', business_type: 'School', owner_name: 'DepEd Quezon City', barangay: 'Novaliches', address: 'Regalado Ave., Novaliches, Quezon City', occupancy_type: 'Educational', storeys: 3, floor_area_sqm: 4300.0, contact_number: '0917-100-1004', date_registered: '2018-08-10', status: 'Active' },
  { id: 5, business_name: 'Culiat Grand Hotel', business_type: 'Hotel', owner_name: 'Culiat Hospitality Group', barangay: 'Culiat', address: 'Tandang Sora Ave., Culiat, Quezon City', occupancy_type: 'Residential', storeys: 6, floor_area_sqm: 8900.0, contact_number: '0917-100-1005', date_registered: '2022-02-11', status: 'Active' },
  { id: 6, business_name: 'Talipapa Public Market', business_type: 'Public Market', owner_name: 'Quezon City Market Board', barangay: 'Talipapa', address: 'Talipapa Rd., Quezon City', occupancy_type: 'Mercantile', storeys: 1, floor_area_sqm: 3200.0, contact_number: '0917-100-1006', date_registered: '2017-05-09', status: 'Active' },
  { id: 7, business_name: 'Sauyo Elementary School', business_type: 'School', owner_name: 'DepEd Quezon City', barangay: 'Sauyo', address: 'Sauyo Rd., Quezon City', occupancy_type: 'Educational', storeys: 2, floor_area_sqm: 2600.0, contact_number: '0917-100-1007', date_registered: '2016-06-01', status: 'Active' },
  { id: 8, business_name: 'Regalado Business Center', business_type: 'Office Building', owner_name: 'Regalado Properties Inc.', barangay: 'Fairview', address: 'Regalado Ave., Fairview, Quezon City', occupancy_type: 'Business', storeys: 8, floor_area_sqm: 9800.0, contact_number: '0917-100-1008', date_registered: '2020-01-14', status: 'Active' },
  { id: 9, business_name: 'Payatas Cold Storage', business_type: 'Warehouse', owner_name: 'ColdChain Logistics Corp.', barangay: 'Payatas', address: 'Payatas Rd., Quezon City', occupancy_type: 'Storage', storeys: 1, floor_area_sqm: 5400.0, contact_number: '0917-100-1009', date_registered: '2015-09-30', status: 'Inactive' },
];
