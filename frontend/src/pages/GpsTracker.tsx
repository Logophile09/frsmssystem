  ...
  return (
    <div>
      <div className="mb-5 flex items-center justify-between">
        ...
        <button onClick={() => setAdding(true)} className="rounded-lg bg-ember-600 px-4 py-1.5 text-sm font-medium text-white hover:bg-ember-700">
          + Register Device
        </button>
      </div>
              ...
              <tr key={d.id} className="hover:bg-slate-50">
                ...
                <td className="whitespace-nowrap px-4 py-2.5 text-right">
                  <button
                    ...
                    className="mr-3 text-ember-600 hover:underline disabled:opacity-50"
                  >
      ...
      {adding && (
        <Modal title="Register GPS Device" onClose={() => setAdding(false)}>
          ...
          <div className="mt-5 flex justify-end gap-2">
            ...
            <button onClick={addDevice} className="rounded-lg bg-ember-600 px-4 py-1.5 text-sm font-medium text-white hover:bg-ember-700">
              Register
            </button>
          </div>
        </Modal>
