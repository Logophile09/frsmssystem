...
import ViolationDetailsModal from '../components/details/ViolationDetailsModal';
...
export default function ViolationsPage() {
  // Row clicked in the violations table -- opens ViolationDetailsModal below
  const [viewing, setViewing] = useState<Violation | null>(null);
  ...
  return (
    <>
      ...
      />
      {viewing && <ViolationDetailsModal violation={viewing} onClose={() => setViewing(null)} />}
    </>
  );
}
