...
import InspectionDetailsModal from '../components/details/InspectionDetailsModal';
...
export default function InspectionsPage() {
  // Row clicked in the inspections table -- opens InspectionDetailsModal below
  ...
  return (
    <>
      ...
      />
      {viewing && <InspectionDetailsModal inspection={viewing} onClose={() => setViewing(null)} />}
    </>
  );
}
