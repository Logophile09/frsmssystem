...
import PersonnelDetailsModal from '../components/PersonnelDetailsModal';
...
export default function PersonnelPage() {
  // Row clicked in the roster table -- opens PersonnelDetailsModal below
  // with everything about them (contact info, portal access, recent
  // Attendance history), separate from CrudPage's own Edit modal which
  // still opens from the pencil icon as before.
  ...
  return (
    <>
      ...
      {viewing && <PersonnelDetailsModal personnel={viewing} onClose={() => setViewing(null)} />}
    </>
  );
}
