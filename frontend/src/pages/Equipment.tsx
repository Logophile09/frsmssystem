...
import EquipmentDetailsModal from '../components/details/EquipmentDetailsModal';
...
export default function EquipmentPage() {
  // Row clicked in the inventory table -- opens EquipmentDetailsModal below
  ...
  return (
    <>
      ...
      />
      {viewing && <EquipmentDetailsModal item={viewing} onClose={() => setViewing(null)} />}
    </>
  );
}
