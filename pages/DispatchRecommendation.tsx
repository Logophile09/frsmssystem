  ...
  return (
    <div>
      <div className="mb-5 flex items-start gap-3.5">
        ...
        <div>
          <h1 className="font-display text-xl font-bold text-navy-900 dark:text-slate-100">Dispatch Recommendation</h1>
      ...
      <div className="grid gap-5 lg:grid-cols-[1fr_1.2fr]">
        ...
        <div className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm dark:border-white/10 dark:bg-navy-800">
          <p className="mb-3 text-xs font-semibold uppercase tracking-wide text-slate-500 dark:text-slate-400">Incident details</p>

          <label className="mb-1 block text-xs font-medium text-slate-500 dark:text-slate-400">Load from an active incident (optional)</label>
          <select
          ...
          <label className="mb-1 block text-xs font-medium text-slate-500 dark:text-slate-400">Incident type</label>
          <select
          ...
          <label className="mb-1 block text-xs font-medium text-slate-500 dark:text-slate-400">Alert Level</label>
          <select
            value={form.severity}
        ...
        <div className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm dark:border-white/10 dark:bg-navy-800">
          {!result && (
            <div className="flex h-full min-h-[280px] flex-col items-center justify-center text-center text-slate-400 dark:text-slate-500">
          ...
          {result && (
            <div>
              ...
              <p className="mb-2 text-xs font-semibold uppercase tracking-wide text-slate-500 dark:text-slate-400">Recommended units</p>
              ...
              <p className="mb-2 text-xs font-semibold uppercase tracking-wide text-slate-500 dark:text-slate-400">Decision path</p>
              <div className="space-y-2">
                  ...
                  <div key={i} style={{ marginLeft: step.depth * 16 }} className="flex gap-2">
                    ...
                    <div className="pb-3">
                      <p className="text-sm font-medium text-slate-800 dark:text-slate-200">
                        {step.question} <span className="font-normal text-slate-500 dark:text-slate-400">→ {step.answer}</span>
                      </p>
                      <p className="text-xs text-slate-500 dark:text-slate-400">{step.reasoning}</p>
                    </div>
                  </div>
                ))}
              </div>
