...
('First Aid Kit', 'Medical', 4, 'good', 3, 'AMB-01'),
...
('INC-2026-0001', 'Structure Fire', 'Reported fire on the 2nd floor of a residential building.', 'Fairview, Quezon City', 'high', 'resolved', now() - interval '6 days', now() - interval '6 days' + interval '3 hours'),
('INC-2026-0002', 'Vehicular Accident', 'Two-vehicle collision, one injured.', 'Commonwealth Ave.', 'moderate', 'resolved', now() - interval '4 days', now() - interval '4 days' + interval '2 hours'),
('INC-2026-0003', 'Grass Fire', 'Small grass fire near a vacant lot, contained quickly.', 'Novaliches, Quezon City', 'low', 'resolved', now() - interval '3 days', now() - interval '3 days' + interval '1 hour'),
('INC-2026-0004', 'Medical Emergency', 'Elderly patient with chest pains.', 'Batasan Hills', 'moderate', 'resolved', now() - interval '2 days', now() - interval '2 days' + interval '90 minutes'),
('INC-2026-0005', 'Structure Fire', 'Possible false alarm - smoke detector triggered, no visible fire on arrival.', 'Culiat, Quezon City', 'low', 'dispatched', now() - interval '5 hours', null),
('INC-2026-0006', 'Structure Fire', 'Active fire, occupants trapped on 3rd floor, multiple casualties reported.', 'Payatas, Quezon City', 'critical', 'on_scene', now() - interval '40 minutes', null);

insert into incident_personnel (incident_id, personnel_id) values (1,1),(1,2),(2,2),(3,1),(4,4),(5,3),(6,1),(6,2),(6,4);
insert into incident_vehicles (incident_id, vehicle_id) values (1,1),(2,3),(3,1),(4,3),(5,2),(6,1),(6,2);
...
('GPS-AMB-01', 3, 'offline', 14.6761, 121.0440, 0, 0, now() - interval '3 hours');
